...
{
    log_d("projectID: %s. %d", project_id,sizeof(project_id));
    log_d("_location: %s. %d", location,sizeof(location));
    log_d("_registry_id: %s.%d", registry_id,sizeof(registry_id));
    log_d("_device_id: %s. %d", device_id,sizeof(device_id));
    log_d("_private_key: %s. %d", private_key,sizeof(private_key));
    setProjectId(project_id);
    setLocation(location);
    setRegistryId(registry_id);
    setDeviceId(device_id);
...
{
    String res = String("/v1/projects/") + project_id + "/locations/" + location +
