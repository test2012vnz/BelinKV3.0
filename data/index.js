...
function test1() {
  ...
  var js = {
    project: document.getElementById("t_project_id").value,
    region: document.getElementById("t_region").value,
    registry: document.getElementById("t_registry").value,
    device: document.getElementById("t_device_id").value,
    key: document.getElementById("t_private_key").value
  };
  var mess = "m=83&js=" + JSON.stringify(js);
  console.log(JSON.stringify(js));
  http_post(mess, "Login Err", "/c", 83);
}
